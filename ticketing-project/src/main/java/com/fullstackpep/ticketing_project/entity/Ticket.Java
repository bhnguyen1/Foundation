...
public class Ticket {
    ...
    */
    ...
    /**
     * The id for the user who has submitted a ticket (foreign key)
     * May need to reference the User class instead to get the user's information
    */
    ...
    */
     ...
     * @param status
    */
    public Ticket(Integer submittedBy, int amount, String description) {
    ...
    */
    public Ticket(Integer ticketId, Integer submittedBy, int amount, String description) {
